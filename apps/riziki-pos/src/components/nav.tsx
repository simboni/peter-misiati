...
const TABS: Tab[] = [
  ...
  { href: "/batch", label: "Batch", icon: I("M10 3v6l-5.5 9a2 2 0 0 0 1.8 3h11.4a2 2 0 0 0 1.8-3L14 9V3 M8 3h8 M7 15h10") },
  ...
  { href: "/reports", label: "Reports", icon: I("M4 20V10 M10 20V4 M16 20v-8 M22 20H2") },
];
...
export function BottomNav({ isOwner }: { isOwner: boolean }) {
  ...
  return (
    <nav className="no-print fixed inset-x-0 bottom-0 z-30 mx-auto grid max-w-lg grid-cols-5 border-t border-line bg-white pb-[env(safe-area-inset-bottom)]">
      {tabs.map((t) => {
